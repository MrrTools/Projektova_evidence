create or replace PACKAGE pev_k_main_rf
/**
*Projektova evidence.
* <p>
...
AS
  ...
  -- $Header: pev_k_main.ks.sql RM #46711  2021-21-05 15:00:03 journal procedury $
...
/**
  ...
  * @param p_email                  - status pre kopirovanie kampane
  *
...
procedure upd_projects (p_id IN NUMBER , p_name IN VARCHAR2 , p_project_state IN NUMBER ,p_identification IN NUMBER , p_project_status IN NUMBER , p_kakadu_number IN VARCHAR2 , p_bdc_number IN VARCHAR2 , p_bdc_ops IN VARCHAR2,
                        ...
                        p_project_description IN VARCHAR2 , p_descr_scope IN VARCHAR2 , p_layout IN NUMBER , p_layout_url IN VARCHAR2, p_budget_approve_date IN DATE, id_out OUT NUMBER, p_budget_approve IN NUMBER, p_forecast_approve IN NUMBER,
...
/**  send_mails
  ...
  */
  ...
  PROCEDURE job_na_maily (pi_project_id NUMBER default NULL );
...
/**
  * Procedure that  copy developer into  project .
  *
...
/**  create_mail_end_project
  * Procedura naplánuje email o ukončení projektu v PEV_T_MAIL_SCHEDULER
  * <p>
  * <b>INPUT</b>:
  * <ul>
  * </ul>
  * <p>
  * <b>OUTPUT</b>: <ul>
  * <li>PEV_T_MAIL_SCHEDULER</li>
  * </ul>
  *
  * @headcom
  * @p_project_id					-  id  projektu
  * @version 2021-01-31  limrich    vytvorení procedury
  */
PROCEDURE create_mail_end_project ( p_project_id IN NUMBER);

/**  send_mail_end_projects
  * Procedura rozešle emaily z tabulky PEV_T_MAIL_SCHEDULER
  * <p>
  * <b>INPUT</b>:
  * <ul>
  ...
  */
  ...
  /**  send_mail_end_projects
  * Procedura updatuje projektové budgety a forecasty z ADW Jedoxu
  * <p>
  * <b>INPUT</b>:
  * <ul>
  * FA_JEDOX_BUDGET_CLH_V
  * </ul>
  * <p>
  * <b>OUTPUT</b>: <ul>
  * <li>PEV_T_PROJECTS/li>
  * </ul>
  *
  * @headcom
  *
  * @version RM #45121  2021-03-16  vhomola  oprava upd_projects_budget_forecast podle nového zadání
  */
